...
p denver_biscuit_co[:hours].first[:open].fetch(2)[:start]
p denver_biscuit_co.dig(:hours, 0, :open, 1, :start)
# Return the closing hour on Saturday (day 5) ("1500")
p denver_biscuit_co.dig(:hours, 0, :open, 5, :end)
# Return the current open status (is_now_open) (true)
p denver_biscuit_co.dig(:hours, 0, :is_open_now)
